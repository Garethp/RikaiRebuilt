(function (global, factory) {
  ...
  /* webextension-polyfill - v0.2.1 - Mon May 21 2018 19:51:50 */
  ...
  if (!isDefined(window, "browser") || !(() => {
    ...
    let supportsPromises = !(isDefined(window.browser, "runtime") ? isDefined(window.browser.runtime, "lastError") : isDefined(window.browser, "extension") && isDefined(window.browser.extension, "lastError"));
    if (supportsPromises) {
      return true;
    }
    if (!supportsPromises) {
