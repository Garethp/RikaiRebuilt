...
function Dexie(dbName, options) {
    ...
    */
    ...
    props(Table.prototype, {
        ...
        bulkAdd: function (objects, keys$$1, individualSuccessHook) {
            ...
            return this._idbstore(READWRITE, function (resolve, reject, idbstore, trans) {
                ...
                if (creatingHook !== nop || ( individualSuccessHook !== null &&  individualSuccessHook !== nop)) {
                    //
                    ...
                    tryCatch(function () {
                        for (var i = 0, l = objects.length; i < l; ++i) {
                            if ( individualSuccessHook === nop)  individualSuccessHook = null;
                            hookCtx = { onerror: null, onsuccess:  individualSuccessHook };
