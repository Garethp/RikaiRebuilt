/**
 * Code written by, and belonging to, https://github.com/birtles and used with his permission. All credit goes to him,
 * but all blame for bugs to me. Please stop by https://github.com/birtles/rikaichamp and give his repo a star if you
 * haven't already
 */
...
const deinflectRuleData: Array<[string, string, number, number]> = [
    ...
    ['逝ったら', '逝く', 640, DeinflectReason.Tari],
    ['逝ったり', '逝く', 640, DeinflectReason.Tara],
    ['往ったら', '往く', 640, DeinflectReason.Tari],
    ['往ったり', '往く', 640, DeinflectReason.Tara],
    ['請うたら', '請う', 640, DeinflectReason.Tari],
    ['請うたり', '請う', 640, DeinflectReason.Tara],
    ['乞うたら', '乞う', 640, DeinflectReason.Tari],
    ['乞うたり', '乞う', 640, DeinflectReason.Tara],
    ['恋うたら', '恋う', 640, DeinflectReason.Tari],
    ['恋うたり', '恋う', 640, DeinflectReason.Tara],
    ['問うたら', '問う', 640, DeinflectReason.Tari],
    ['問うたり', '問う', 640, DeinflectReason.Tara],
    ['負うたら', '負う', 640, DeinflectReason.Tari],
    ['負うたり', '負う', 640, DeinflectReason.Tara],
    ['沿うたら', '沿う', 640, DeinflectReason.Tari],
    ['沿うたり', '沿う', 640, DeinflectReason.Tara],
    ['添うたら', '添う', 640, DeinflectReason.Tari],
    ['添うたり', '添う', 640, DeinflectReason.Tara],
    ['副うたら', '副う', 640, DeinflectReason.Tari],
    ['副うたり', '副う', 640, DeinflectReason.Tara],
    ['厭うたら', '厭う', 640, DeinflectReason.Tari],
    ['厭うたり', '厭う', 640, DeinflectReason.Tara],
    ...
    ['しとく', 'す', 514, DeinflectReason.Toku],
